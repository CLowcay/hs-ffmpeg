...
newtype AVPixelFormat = AVPixelFormat CInt deriving (Eq, Show, CEnum, Storable)
pattern PixFmtNone = AVPixelFormat (#{const PIX_FMT_NONE})
pattern PixFmtYuv420p = AVPixelFormat (#{const PIX_FMT_YUV420P})
pattern PixFmtYuyv422 = AVPixelFormat (#{const PIX_FMT_YUYV422})
pattern PixFmtRgb24 = AVPixelFormat (#{const PIX_FMT_RGB24})
pattern PixFmtBgr24 = AVPixelFormat (#{const PIX_FMT_BGR24})
pattern PixFmtYuv422p = AVPixelFormat (#{const PIX_FMT_YUV422P})
pattern PixFmtYuv444p = AVPixelFormat (#{const PIX_FMT_YUV444P})
pattern PixFmtYuv410p = AVPixelFormat (#{const PIX_FMT_YUV410P})
pattern PixFmtYuv411p = AVPixelFormat (#{const PIX_FMT_YUV411P})
pattern PixFmtGray8 = AVPixelFormat (#{const PIX_FMT_GRAY8})
pattern PixFmtMonowhite = AVPixelFormat (#{const PIX_FMT_MONOWHITE})
pattern PixFmtMonoblack = AVPixelFormat (#{const PIX_FMT_MONOBLACK})
pattern PixFmtPal8 = AVPixelFormat (#{const PIX_FMT_PAL8})
pattern PixFmtYuvj420p = AVPixelFormat (#{const PIX_FMT_YUVJ420P})
pattern PixFmtYuvj422p = AVPixelFormat (#{const PIX_FMT_YUVJ422P})
pattern PixFmtYuvj444p = AVPixelFormat (#{const PIX_FMT_YUVJ444P})
pattern PixFmtXvmcMpeg2Mc = AVPixelFormat (#{const PIX_FMT_XVMC_MPEG2_MC})
pattern PixFmtXvmcMpeg2Idct = AVPixelFormat (#{const PIX_FMT_XVMC_MPEG2_IDCT})
pattern PixFmtUyvy422 = AVPixelFormat (#{const PIX_FMT_UYVY422})
pattern PixFmtUyyvyy411 = AVPixelFormat (#{const PIX_FMT_UYYVYY411})
pattern PixFmtBgr8 = AVPixelFormat (#{const PIX_FMT_BGR8})
pattern PixFmtBgr4 = AVPixelFormat (#{const PIX_FMT_BGR4})
pattern PixFmtBgr4Byte = AVPixelFormat (#{const PIX_FMT_BGR4_BYTE})
pattern PixFmtRgb8 = AVPixelFormat (#{const PIX_FMT_RGB8})
pattern PixFmtRgb4 = AVPixelFormat (#{const PIX_FMT_RGB4})
pattern PixFmtRgb4Byte = AVPixelFormat (#{const PIX_FMT_RGB4_BYTE})
pattern PixFmtNv12 = AVPixelFormat (#{const PIX_FMT_NV12})
pattern PixFmtNv21 = AVPixelFormat (#{const PIX_FMT_NV21})
pattern PixFmtArgb = AVPixelFormat (#{const PIX_FMT_ARGB})
pattern PixFmtRgba = AVPixelFormat (#{const PIX_FMT_RGBA})
pattern PixFmtAbgr = AVPixelFormat (#{const PIX_FMT_ABGR})
pattern PixFmtBgra = AVPixelFormat (#{const PIX_FMT_BGRA})
pattern PixFmtGray16be = AVPixelFormat (#{const PIX_FMT_GRAY16BE})
pattern PixFmtGray16le = AVPixelFormat (#{const PIX_FMT_GRAY16LE})
pattern PixFmtRgb32 = AVPixelFormat (#{const PIX_FMT_RGB32})
pattern PixFmtRgb32_1 = AVPixelFormat (#{const PIX_FMT_RGB32_1})
pattern PixFmtBgr32 = AVPixelFormat (#{const PIX_FMT_BGR32})
pattern PixFmtBgr32_1 = AVPixelFormat (#{const PIX_FMT_BGR32_1})
pattern PixFmtGray16 = AVPixelFormat (#{const PIX_FMT_GRAY16})
pattern PixFmtRgb565 = AVPixelFormat (#{const PIX_FMT_RGB565})
pattern PixFmtRgb555 = AVPixelFormat (#{const PIX_FMT_RGB555})
pattern PixFmtBgr565 = AVPixelFormat (#{const PIX_FMT_BGR565})
pattern PixFmtBgr555 = AVPixelFormat (#{const PIX_FMT_BGR555})
