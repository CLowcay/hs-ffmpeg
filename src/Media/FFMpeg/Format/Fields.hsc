...
avstream_time_base :: Field AVStream (Maybe AVRational) ReadWrite
...
avstream_sample_aspect_ratio :: Field AVStream (Maybe AVRational) ReadWrite
...
avstream_avg_frame_rate :: Field AVStream (Maybe AVRational) ReadWrite
...
formatSetFilename :: (MonadIO m, MonadThrow m) =>
